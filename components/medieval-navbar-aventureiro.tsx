...
import { Menu, Sword, ScrollText, Shield, Home, LogOut, HandHelping, Dog, Swords, BookOpenText } from "lucide-react";
...
export function MedievalNavBarAv() {
  ...
  const routes = [
    ...
    { href: `/aventureirotaverna/${uid}`,   label: "Taverna", icon: <Home className="h-5 w-5" />, roles: ["Cliente","Sub-Admin","Admin"] },
    { href: `/aventureiroficha/${uid}`,     label: "Ficha", icon: <ScrollText className="h-5 w-5" />, roles: ["Cliente","Sub-Admin","Admin"] },
    ...
    { href: `/aventureirocombate/${uid}`,   label: "Combate", icon: <Swords className="h-5 w-5" />, roles: ["Cliente","Sub-Admin","Admin"] },
